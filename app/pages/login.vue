...
async function login(){
  ...
  if(!body.success){
    toast.add({ title: body.error.errors[0].message, icon: 'i-heroicons-exclamation-triangle-20-solid', color: 'red' })
...
<template>
  <main class="mx-auto flex min-h-screen flex-col items-center justify-center space-y-5 bg-white px-6 dark:bg-slate-900">
