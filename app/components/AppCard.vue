...
const menu = computed(() => [[
  { label: t('apps.details'), icon: 'i-heroicons-star-20-solid', click: () => navigateTo(`/apps/${props.process.name}`) },
  ...
  <UCard class="size-full" :ui="{background: 'bg-gray-100 dark:bg-gray-800'}">
    <div class="flex flex-col items-start justify-center space-y-1">
      <div class="mb-2 flex w-full items-center justify-between">
        <p class="flex items-center justify-center space-x-2 text-blue-500 dark:text-blue-400">
